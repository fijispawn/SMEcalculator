...
const Balance = () => {
  ...
  const inputNames = {
    ...
    reserves: "Денежные резервы",
    clientDebt: "Задолженность покупателей",
    upFrontPayment: "Предоплата поставщику",
    otherAssets: "Прочие оборотные активы",
    requiredPayments: "Текущие обязательства",
  };
...
const handleSave = () => {
  if (selectedDate.month && selectedDate.year) {
    ...
    fetch("https://enterpizemate.dyzoon.dev/api/analytics/save-balance", {
      method: "POST",
      headers: {
